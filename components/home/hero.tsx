...
export function Hero() {
  ...
  return (
    <div className="relative flex min-h-[100svh] w-full flex-col justify-center bg-canvas text-white">
      <div aria-hidden className="pointer-events-none absolute -right-10 top-1/4 h-[40vh] w-[40vh] rounded-full bg-brand/20 blur-[100px]" />
      <div aria-hidden className="pointer-events-none absolute -left-16 bottom-1/4 h-[28vh] w-[28vh] rounded-full bg-brand/10 blur-[80px]" />
