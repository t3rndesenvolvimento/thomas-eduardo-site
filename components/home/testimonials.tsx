...
function ReviewCard({
 ...
 return (
 <div className="group relative flex h-full w-full flex-col justify-between overflow-hidden rounded-2xl border border-white/10 bg-[#0d0e14] p-6 sm:p-8 lg:p-10 transition-all duration-300 hover:border-white/20 hover:bg-[#131522] shadow-lg">
 <div>
 {/* Quote icon */}
 <Quote
 ...
 {/* Author */}
 <div className="mt-4 flex items-center gap-3 pt-3.5">
 {/* Avatar */}
 ...
 <p className="truncate font-mono text-xs text-white/40 sm:text-sm">
 {review.title}
 </p>
 </div>
 </div>
...
export function Testimonials() {
 ...
 className="text-4xl sm:text-5xl md:text-6xl lg:text-[4.5rem] font-display font-bold text-white tracking-tight leading-[1.05]"
 >
