...
export function About() {
  ...
  return (
    <section
      id="about"
      className="relative overflow-hidden border-t border-black/10 bg-white text-black py-8 sm:py-20 md:py-24"
    >
      <motion.div
        ...
        <div className="grid items-start gap-6 sm:gap-10 lg:grid-cols-[1fr_1.3fr] lg:gap-16">
          ...
          <div className="flex flex-col items-start lg:sticky lg:top-32">
            ...
            <motion.h2
              ...
              className="font-display text-[clamp(1.6rem,4.5vw,4rem)] sm:text-[clamp(2.2rem,4.5vw,4rem)] font-bold leading-[0.95] tracking-tight text-black"
            >
          ...
          <div className="flex flex-col gap-4 sm:gap-8 lg:pt-12">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="max-w-[48ch] space-y-2 sm:space-y-4 text-sm sm:text-base leading-relaxed text-black/75 sm:text-lg"
            >
              <p>{t.about.p1}</p>
              <p>{t.about.p2}</p>
            </motion.div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:grid-cols-2 sm:gap-4">
              {t.about.pillars.map((p, index) => (
                <motion.div
                  ...
                  className={`group relative overflow-hidden rounded-xl sm:rounded-2xl border border-black/10 bg-[#F8F9FA] p-3 sm:p-7 text-black transition-all hover:border-black/20 hover:shadow-md ${
                ...
                >
                  <div className="relative z-10 flex flex-col gap-2 sm:gap-4">
                    ...
                    <div>
                      <h3 className="font-display text-xs sm:text-lg font-bold tracking-tight text-black">
                        {p.title}
                      </h3>
                      <p className="mt-1 sm:mt-2 text-[10px] sm:text-sm leading-relaxed text-black/70 line-clamp-3 sm:line-clamp-none">
                        {p.text}
                      </p>
                    </div>
                  </div>
